...
public class NewsController extends BaseController{
    ...
    public ResponseResult<List<NewsVO>> product(@RequestBody News news, HttpSession session) {
//        String username = session.getAttribute("username").toString();
    ...
    public ResponseResult<JSONObject> getNews(@RequestParam("startPage")Integer startPage,
        ...
        // 调用业务层对象执行
        List<NewsVO> data = newsService.getNews(startPage,pageSize);
...
//        String username = session.getAttribute("username").toString();
    ...
    public ResponseResult<JSONObject> searchNews(@RequestBody SearchNews search) {
        ...
        // 调用业务层对象执行
        List<NewsVO> data = newsService.searchNews(new_title,new_type,startPage,pageSize);
